...
WINE_PV=$(ver_rs 2 -)
inherit git-r3
EGIT_REPO_URI="https://github.com/GloriousEggroll/wine-ge-custom.git"
EGIT_BRANCH="master"

DESCRIPTION="GloriousEggroll's fork of wine."
...
src_prepare() {
	...
	sed -i "s/wine_build[^1]*1/& (GE-custom-${WINE_PV})/" configure.ac || die
...
src_configure() {
	...
	local conf=(
		...
		# (IUSE="X wayland" may be added in wine-ge-custom-10 or 11)
		--without-wayland
