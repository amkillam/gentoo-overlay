...
multilib_src_install() {
	if ! multilib_is_native_abi; then
		for dir in docs man vapi; do 
			ln -s /var/tmp/portage/net-misc/networkmanager-1.46.0-r1/work/NetworkManager-1.46.0-abi_x86_64.amd64/$dir \
			/var/tmp/portage/net-misc/networkmanager-1.46.0-r1/work/NetworkManager-1.46.0-abi_x86_32.x86 
		done
	fi
